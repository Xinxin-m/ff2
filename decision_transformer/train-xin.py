...
import sys
import torch
# python ff_control/transformer_controller/decision_transformer/main_train_time.py
...
mdp_constr = True
dataset_scenario = 'time_40_100'
chunksize = 100

model_config = TTO_manager.transformer_import_config(model_name_4_saving)
datasets, dataloaders = TTO_manager.get_train_val_test_data(mdp_constr=True, dataset_scenario=dataset_scenario,
                                                            timestep_norm=False, chunksize=chunksize)
